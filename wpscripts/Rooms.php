...
$FTGMeetings = DoStripSlashes( $_POST['Meetings'] );
$FTGRehearsals = DoStripSlashes( $_POST['Rehearsals'] );
$FTGFunction = DoStripSlashes( $_POST['Function'] );
...
if ( $validationFailed === false ) {
 ...
 $emailSubject = FilterCChars("Masonic Hall Radlett Website : Rooms Form");
  
 $emailBody = "Name : $FTGName <email : $FTGemail>\n"
  . "\n"
  . "#FTG_E_DATE DD/MM/YYYY#\n"
  . "\n"
  . "Meetings : $FTGMeetings, Rehearsals : $FTGRehearsals, Function : $FTGFunction\n"
  . "\n"
...
header("Location: http://masonic-hall-radlett.cf/room_hire.html");
